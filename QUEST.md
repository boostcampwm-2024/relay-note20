...
- 새로 만든 이유: 피어세션은 챌린지과정에서만 얻을 수 있는 장점이라고 생각해서 이것을 최대한 이용해서 성장을 도모할 수 있는 퀘스트가 있으면 좋을 것 같다고 생각하였다.
...
- 보존한 이유: 이번주차에서 유의미한 미션이라고 생각한다.

### Quest 5

- 배경: 소통능력 배양 및 잘 질문하는 법을 배우기 위해서
- 퀘스트: 오류가 발생하면 슬랙에 질문하기
- 수행 기준: 래퍼런스 질문하기 or 시도한 내용과 내 생각을 어필하며 답 구하기

- 새로 만든 이유: 좋은 질문과 대답을 이끌어내는 경험을 했으면 좋겠다고 생각
...
새로만든 이유: 궁극적으로 개발자로서 올라서기 위해서라면 필요한 능력치이기 때문에
